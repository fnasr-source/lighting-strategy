...
.agenda-strip {{ display: grid; grid-template-columns: repeat(5, 1fr); gap: 12px; margin-top: 18px; }}
.agenda-item {{
...
.agenda-step {{ font-size: 11px; letter-spacing: 0.12em; text-transform: uppercase; color: var(--aw-gold); font-weight: 700; }}
.agenda-title {{ margin-top: 6px; font-size: 14px; font-weight: 700; color: var(--aw-navy); }}
.agenda-text {{ margin-top: 4px; font-size: 12px; color: var(--aw-muted); }}
.hero {{
  position: relative;
  overflow: hidden;
  margin-top: 10px;
...
@media (max-width: 980px) {{
  .meta-grid, .kpi-grid, .chart-grid, .seq-grid, .timeline-grid, .signal-grid, .story-grid, .agenda-strip {{ grid-template-columns: 1fr; }}
...
def build_html(asset_prefix: str) -> str:
    ...
    summary_cards = ''.join([
        "<div class='story-card'><div class='story-title'>The shift</div><div class='story-text'>The go-to-market motion is being narrowed to an education-first MENA wedge with one pilot-led CTA instead of broad outreach across unrelated personas.</div></div>",
        "<div class='story-card'><div class='story-title'>Already activated</div><div class='story-text'>Campaign architecture, CRM hygiene, education lead seeding, and the manual recovery queue are already operating. This is a live reset, not a planning-only proposal.</div></div>",
        "<div class='story-card'><div class='story-title'>Meeting decisions</div><div class='story-text'>The next 30 days depend on alignment around the education landing page, manual follow-up discipline, and booked-demo KPI.</div></div>",
    ])
    agenda_items = ''.join([
        "<div class='agenda-item'><div class='agenda-step'>01</div><div class='agenda-title'>Snapshot</div><div class='agenda-text'>Where performance stands now.</div></div>",
        "<div class='agenda-item'><div class='agenda-step'>02</div><div class='agenda-title'>Reset</div><div class='agenda-text'>What has already changed live.</div></div>",
        "<div class='agenda-item'><div class='agenda-step'>03</div><div class='agenda-title'>Direction</div><div class='agenda-text'>Why education-first is the right wedge.</div></div>",
        "<div class='agenda-item'><div class='agenda-step'>04</div><div class='agenda-title'>Roadmap</div><div class='agenda-text'>What the next 30 days should look like.</div></div>",
        "<div class='agenda-item'><div class='agenda-step'>05</div><div class='agenda-title'>Approvals</div><div class='agenda-text'>What needs alignment in the meeting.</div></div>",
    ])
    decision_items = ''.join([
        "<div class='decision-item'><div class='decision-badge'>1</div><div class='small'><strong>Approve education-first as the lead commercial motion</strong><br/>Run the next 30 days around institutions, instructors, and training teams in Egypt, Saudi Arabia, and UAE.</div></div>",
        "<div class='decision-item'><div class='decision-badge'>2</div><div class='small'><strong>Approve the dedicated pilot landing page</strong><br/>Use one destination that explains the 30-day pilot, the proof layer, and the booking CTA with less friction.</div></div>",
        "<div class='decision-item'><div class='decision-badge'>3</div><div class='small'><strong>Approve manual follow-up on warm opportunities</strong><br/>The existing hot and warm leads need fast operator follow-up, not more automated waiting.</div></div>",
        "<div class='decision-item'><div class='decision-badge'>4</div><div class='small'><strong>Approve the KPI standard for this sprint</strong><br/>Judge the next phase on booked demos and qualified conversations rather than send count alone.</div></div>",
    ])
...
<body>
  <nav class='nav'>
    <div class='nav-inner'>
      ...
      <ul class='nav-links'>
        ...
        <li><a href='#diagnosis'>Performance</a></li>
        <li><a href='#strategy'>Strategy</a></li>
        <li><a href='#action-plan'>Roadmap</a></li>
  ...
  <main class='main' id='top'>
    ...
    <section class='section'>
      <div class='agenda-strip'>{agenda_items}</div>
    </section>
    ...
    <section class='section section-shell' id='summary'>
      ...
      <h2>Growth reset summary</h2>
      <p class='section-intro'>This report is designed for the meeting flow: current performance, live reset changes, the new commercial direction, the 30-day rollout, and the decisions needed to move forward with clarity.</p>
    ...
    <section class='section section-shell'>
      ...
      <h2>Where performance stands today</h2>
      <p class='section-intro'>The current issue is not a lack of activity. The issue is conversion quality. The reset is intended to improve that by narrowing the wedge, tightening the offer, and forcing follow-through on the warm opportunities already in the system.</p>
    ...
    <section class='section section-shell' id='changes'>
      <div class='section-kicker'>Live reset</div>
      <h2>What has already changed in market</h2>
      <p class='section-intro'>The campaign mix, CRM cleanup, and education routing are already live. This section shows the operational shift that has already been activated, not just the next plan.</p>
      <div class='chart-grid'>
        <div class='chart-card'>
    ...
    <section class='section section-shell'>
      ...
      <h2>What was already built, and what we learned from it</h2>
      <p class='section-intro'>Substantial execution happened before the reset. The issue was not lack of work; it was that the original motion was too broad and too weak at the point of conversion.</p>
      <div class='grid'>
    ...
    <section class='section section-shell' id='strategy'>
      <div class='section-kicker'>Strategic direction</div>
      <h2>The next commercial direction</h2>
      <p class='section-intro'>The next phase is not about sending more of the same outreach. It is about using an education-first offer, a tighter geographic focus, and one pilot CTA that can move qualified prospects into conversations faster.</p>
      <div class='chart-grid'>
        <div class='chart-card'>
    ...
    <section class='section section-shell' id='action-plan'>
      <div class='section-kicker'>30-day roadmap</div>
      <h2>The next 30 days</h2>
      <p class='section-intro'>The next phase should run as a controlled sprint. The goal is to turn warm and near-fit education leads into meetings, then decide whether the wedge is strong enough to scale.</p>
    ...
    <section class='section section-shell' id='sequences'>
      <div class='section-kicker'>Outreach system</div>
      <h2>Multi-channel sequence maps</h2>
      <p class='section-intro'>These sequence maps show how email, LinkedIn, and manual follow-up work together for each audience instead of acting as isolated tactics.</p>
      <div class='seq-grid'>
    ...
    <section class='section section-shell'>
      <div class='chart-grid'>
        ...
        <div class='chart-card'>
          <div class='chart-head'><div class='chart-title'>Meeting approvals</div><span class='badge next'>Decision checklist</span></div>
          <div class='decision-list'>{decision_items}</div>
          <p class='quote'>This meeting should close with a clear decision on the wedge, the landing page path, the follow-up discipline, and the KPI standard for the sprint.</p>
        </div>
      </div>
    </section>
    ...
    <section class='section section-shell' id='roadmap'>
      ...
      <p class='section-intro'>This final section is here for credibility in the meeting. It shows where the recommendation comes from without forcing the presentation to begin with raw detail.</p>
