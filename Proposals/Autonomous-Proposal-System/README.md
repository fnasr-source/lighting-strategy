...
Use the Autonomous Proposal System playbook at Proposals/Autonomous-Proposal-System/PLAYBOOK.md.
...
Uses existing AW brand fonts from `_Proposal-System/templates/growth-packages-assets/fonts/`:
...
- Requires `puppeteer-core` (installed in `_Proposal-System/payments/`)
