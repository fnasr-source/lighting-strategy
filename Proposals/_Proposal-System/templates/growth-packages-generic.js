    ...
    state.slides.forEach((slide, index) => {
      ...
      const headerHtml = showHeader ? `
        <div class="slide-header">
          <img src="growth-packages-assets/brand/brandmark.png" class="brand-mark-mini">
        </div>
      ` : '';
...
function renderSlideContent(slide) {
  ...
  switch (layout) {
    case 'cover':
      return `
        <img src="growth-packages-assets/brand/brandmark.png" class="brand-mark-large">
    ...
    case 'hero-split': // Renovated to Strategic Grid Layout
      return `
        <div class="layout-strategic-grid">
          ...
          <img src="growth-packages-assets/generated/exec-visual.png">
        </div>
      `;
        ...
        <div class="slide-content">
          ...
          <div class="investment-row">
            ...
            <div class="investment-brand">
              <img src="growth-packages-assets/brand/brandmark.png" class="brand-mark-investment">
            </div>
          </div>
        </div>
      `;
    ...
    case 'closing':
      return `
        <img src="growth-packages-assets/generated/closing-bg.png" style="position:absolute; top:0; left:0; width:100%; height:100%; object-fit:cover; opacity:0.3; z-index:0;">
        <div style="position:relative; z-index:1; display:flex; flex-direction:column; align-items:center;">
          ...
          <img src="growth-packages-assets/brand/logo.png" class="logo-closing">
        </div>
      `;
