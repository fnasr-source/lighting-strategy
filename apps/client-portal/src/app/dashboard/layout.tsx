...
const allNavItems: NavItem[] = [
    ...
    { section: 'Client Artifacts' },
    { label: 'Reports', href: '/dashboard/reports', icon: FileText, permission: 'artifacts:read' },
    { label: 'Strategies', href: '/dashboard/strategies', icon: BookOpen, permission: 'artifacts:read' },
    { label: 'Presentations', href: '/dashboard/presentations', icon: Globe, permission: 'artifacts:read' },
    { label: 'Ad Copies', href: '/dashboard/ad-copies', icon: MessageSquare, permission: 'artifacts:read' },
    { label: 'Campaign Flows', href: '/dashboard/campaign-flows', icon: Zap, permission: 'artifacts:read' },
    { section: 'System' },
...
const clientNavItems: NavItem[] = [
    ...
    { label: 'Presentations', href: '/dashboard/presentations', icon: Globe },
    { label: 'Ad Copies', href: '/dashboard/ad-copies', icon: MessageSquare },
    { label: 'Campaign Flows', href: '/dashboard/campaign-flows', icon: Zap },
