# Client Workspace: Basseqat

This folder is the canonical internal workspace for Basseqat.
...
## Publish Paths
- Portal artifact source path example: `clients/basseqat/strategy/`
- Ops presentation path example: `https://ops.admireworks.com/presentations/basseqat/`
