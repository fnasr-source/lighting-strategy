# Client Workspace: Ein Abaya

This folder is the canonical internal workspace for Ein Abaya.
...
## Publish Paths
- Portal artifact source path example: `clients/ein-abaya/strategy/`
- Ops presentation path example: `https://ops.admireworks.com/presentations/ein-abaya/`
