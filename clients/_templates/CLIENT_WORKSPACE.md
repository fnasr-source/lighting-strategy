...
This folder is the canonical internal workspace for {Client Name}.
...
## Publish Paths
- Portal artifact source path example: `clients/{client-slug}/strategy/`
- Ops presentation path example: `https://ops.admireworks.com/presentations/{client-slug}/`
