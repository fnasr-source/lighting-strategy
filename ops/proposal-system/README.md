...
- Canonical internal CRM page: `ops/proposal-system/_Outgoing/_internal-crm/index.html`
...
3. Publishes outgoing one-page to `ops/proposal-system/_Outgoing/{PROPOSAL_NUMBER}/`
...
- `ops/proposal-system/_Outgoing/{PROPOSAL_NUMBER}/one-page.html`
