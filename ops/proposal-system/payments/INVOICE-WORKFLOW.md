...
|--------|----------|---------|-------------|
| **Static HTML Invoices** | `clients/{Client}/invoices/{INVOICE_NUM}/invoice.html` | Self-contained invoice pages with CSS, hosted on ops.admireworks.com | `ops.admireworks.com/clients/{Client}/invoices/{NUM}/invoice.html` |
...
1. Check `ops/proposal-system/payments/invoice-registry.csv` for the latest sequence
2. Increment the sequence number (e.g., if last is `AWI-202603-002`, next is `AWI-202603-003`)
3. Reference: `ops/proposal-system/payments/INVOICE-NUMBERING.md`

---

## Step 2: Determine Pricing

1. Reference `ops/proposal-system/PRICING-STRUCTURE.md` for standard rates
...
4. Update `ops/proposal-system/payments/payment-links.csv` with the new link
5. Reference: `ops/proposal-system/payments/STRIPE-CONFIG.md`
...
1. Copy the template: `ops/proposal-system/payments/templates/invoice-template.html`
2. Save to: `clients/{Client}/invoices/{INVOICE_NUM}/invoice.html`
